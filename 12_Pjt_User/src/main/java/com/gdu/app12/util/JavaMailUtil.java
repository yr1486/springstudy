...
public class JavaMailUtil {
  ...
  public void sendJavaMail(String to, String title, String content) {
    ...
    try {
      ...
      properties.put("mail.smtp.starttls.enble", env.getProperty("spring.mail.properties.mail.smtp.starttls.enable"));
