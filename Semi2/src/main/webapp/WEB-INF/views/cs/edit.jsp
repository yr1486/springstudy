...
<script>
	...
	function fnRemoveAttach(attachNo){
		...
		location.href = '${contextPath}/cs/removeAttach.do?csNo=${cs.csNo}&attachNo=' + attachNo;
	}
</script>
</head>
<body>
	...
	<div>
		...
		<form method="post" enctype="multipart/form-data" action="${contextPath}/cs/modify.do">
			<div>
				<label for="csTitle">제목</label>
				<input type="text" id="csTitle" name="csTitle" value="${cs.csTitle}">
			</div>
			<div>
				<label for="csContent">내용</label><br>
				<textarea id="csContent" name="csContent" rows="5" cols="30">${cs.csContent}</textarea>
			</div>
			<div>
