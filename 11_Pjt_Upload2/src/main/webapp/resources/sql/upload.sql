...
CREATE TABLE ATTACH (
        ...
        PATH                      VARCHAR2(300 BYTE) NOT NULL, -- 첨부파일 경로
        ORIGIN_NAME           VARCHAR2(300 BYTE) NOT NULL,   -- 첨부파일의 원래이름
        FILESYSTEM_NAME      VARCHAR2(50 BYTE) NOT NULL,    -- 첨부파일의 저장이름
        DOWNLOAD_COUNT   NUMBER,                                  -- 다운로드 횟수
        HAS_THUMBNAIL        NUMBER,                                 -- 썸네일이 있으면 1, 없으면 0
        UPLOAD_NO              NUMBER NOT NULL                     -- 게시글 FK
);
